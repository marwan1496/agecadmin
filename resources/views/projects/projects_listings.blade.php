...
<section class="headings">
    <div class="text-heading text-center">
        <div class="container">
            <h1>Projects</h1>
            <h2><a href="{{URL::to('/');}}">Home </a> &nbsp;/&nbsp; Projects</h2>
        </div>
    </div>
</section>
<!-- END SECTION HEADINGS -->
        <!-- START SECTION PROPERTIES LISTING -->
        <section class="properties-list featured portfolio blog ho-17" style="padding: 0;">
            <div class="container">
                        ...
                        <div class="detail-wrapper-body">
                            <div class="listing-title-bar">
                                <div class="text-heading text-left">
                                    <p class="font-weight-bold mb-0 mt-3">{{count($projects)}} Search results</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row portfolio-items">
                    ...
                    <div class="item col-lg-4 col-md-6 col-xs-12 landscapes sale">
                        <div class="project-single mb-0" data-aos="fade-up">
                            <a href="{{URL::to('/');}}/project-details/{{$project->id}}" class="recent-16">
